...
/*-----------------------END POPUP----------------------------*/
	...
	$('.headmenu__item').hover(function(){
		$(this).find('.headmenu__item__spoilerMenu').stop( true, true ).fadeIn(300);
	}, function(){
	...
	//
			...
			$('.indexHead_v2__slideLinkButton a').css({'left':"-20px", "opacity":0,"display":"block"});
			...
			function iHv2_changer(toSlide){
				...
				$('.indexHead_v2__slideLinkButton a.active').animate({opacity:0},function(){ $(this).css({'left':"-20px"}) });
	...
	//
		$('body').on('change', '.file_link input[type=file]', function() {
