<?php
//модуль отвечающий за поиск
class SearchResult extends ModuleHornav {
	
	public function __construct() {
		parent::__construct();
		$this->add("query");//содержит поисковый запрос
		$this->add("field");//искомая строка
		$this->add("error_len", false);//ошибка - короткий запрос
		$this->add("data", null, true);//набор данных
	}
